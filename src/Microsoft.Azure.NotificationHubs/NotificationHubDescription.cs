...
namespace Microsoft.Azure.NotificationHubs
{
    ...
    public sealed class NotificationHubDescription : EntityDescription
    {
        ...
        internal static readonly XmlMember[] HubXmlMembers =
        {
            ...
            XmlMember.Create<NotificationHubDescription>(ManagementStrings.DailyOperations, (w, n, o) => XmlContract.WriteLong(w, n, o.DailyOperations, false), (o, e) => o.DailyOperations = XmlContract.ReadLong(e) ?? 0),
            XmlMember.Create<NotificationHubDescription>(ManagementStrings.DailyMaxActiveDevices, (w, n, o) => XmlContract.WriteLong(w, n, o.DailyMaxActiveDevices, false), (o, e) => o.DailyMaxActiveDevices = XmlContract.ReadLong(e) ?? 0),
            XmlMember.Create<NotificationHubDescription>(ManagementStrings.DailyMaxActiveRegistrations, (w, n, o) => XmlContract.WriteLong(w, n, o.DailyMaxActiveRegistrations, false), (o, e) => o.DailyMaxActiveRegistrations = XmlContract.ReadLong(e) ?? 0),
