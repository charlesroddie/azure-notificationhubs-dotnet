...
namespace Microsoft.Azure.NotificationHubs.Tests
{
    public class NotificationHubClientTest
    {
        ...
        public async Task GetAllRegistrationsAsync_CreateTwoRegistrations_GetAllCreatedRegistrations()
        {
            ...
            var fcmRegistration = new FcmV1RegistrationDescription(_configuration["FcmDeviceToken"]);
        ...
        private async Task SendDirectNotificationAsync_ListenOnlyConnectionString_ThrowsUnauthorizedException()
        {
            ...
            var notification = new FcmV1Notification("{\"data\":{\"message\":\"Message\"}}");
            ...
            await Assert.ThrowsAsync<UnauthorizedException>(() => hubClient.SendDirectNotificationAsync(notification, _configuration["FcmDeviceToken"]));
            RecordTestResults();
        }
